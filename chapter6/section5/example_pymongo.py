...
"""
# Author: linyl
# Created Time : 日 12/16 18:03:04 2018
# File Name: example_pymongo.py
# Description:
"""
...
print 'object_id: {}'.format(object_id) # 打印插入的对象ID
...
# 如果没有符合条件的条目也不会提示，但是可以通过rs.deleted_count获得删除的数量
